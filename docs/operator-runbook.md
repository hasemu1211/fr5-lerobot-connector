...
OneJob은 motion을 보내기 전 짧은 recorder 준비 구간에서 상단 카메라 밝기를 검사한다. 기준보다 어둡거나 밝기 근거가 없으면 실행을 시작하지 않고 준비 녹화를 정리한다. 손목 카메라 가림과 일반 영상 품질 경고는 이 시작 조건에 포함되지 않는다. 기준은 recorder readiness 계약이 소유한다.
