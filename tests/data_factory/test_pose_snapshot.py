...
class PoseSnapshotTest(unittest.TestCase):
    ...
    def test_place_calibration_preview(self):
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            write("objects/OBJECT_A.json",{"schema_version":"data_factory.object_profile.v1","object_profile_id":"OBJECT_A","qualification_status":"QUALIFIED","object_datum_digest":digest("datum")})
            write("grasps/top_center.json",{"schema_version":"data_factory.grasp_profile.v1","grasp_profile_id":"top_center","qualification_status":"QUALIFIED","object_profile_id":"OBJECT_A","grasp_margin_mm":20,"grasp_contract_digest":digest("grasp")})
            confirmations=[]
            ...
            job=factory.build_job_spec(selected30,x_mm=10,y_mm=5,job_id="job-1",robot_system_id="fr5-lab-a",collection_profile_id="collection",cell_calibration_id="cal-3",object_profile_id="OBJECT_A",grasp_profile_id="top_center",operator_or_agent_id="op",approval_expiry="2099-01-01T00:00:00Z")
