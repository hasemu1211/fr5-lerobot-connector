...
def motion():
    ...
    return {"schema_version":"fr5.motion_program.v1","resolved_job_digest":"sha256:"+"a"*64,"binding_digests":digests,"frames":{"planning_frame":"base_link","planning_group":"fairino5_v6_group","tool_link":"wrist3_link"},"planning":{"pipeline_id":"pilz_industrial_motion_planner","ptp_planner_id":"PTP","lin_planner_id":"LIN","goal_tolerances":{"position_m":.001,"orientation_rad":.01,"joint_rad":.01},"max_joint_state_age_s":1},"steps":phases}
class T:
