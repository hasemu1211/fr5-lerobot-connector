...
- [ ] Integrate exact v4 runtime-input production and protocol admission through the normal caller, then independently review the combined producer/consumer path. Preserve exact v3 approvals rather than treating protocol pins as minimum versions.
