...
- [ ] Close retained-transaction quarantine recovery and verify original-condition next-Collection consumption without semantic PASS, source-data mutation or a second recorder. Partial and uncertain saves remain explicitly unresolved rather than silently discarded.
