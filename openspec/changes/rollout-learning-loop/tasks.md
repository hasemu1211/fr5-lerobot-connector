...
- [x] Preserve canonical cross-workspace v4 source/destination bindings through learned compilation alongside existing v2; delegate endpoint validation to the source owner and reject unknown/nested schemas. Correction ab41b19 passes 113 focused tests. Fresh r5 inference passed source-age checks but encountered the pre-fix source-version rejection; end-to-end runtime admission and independent review remain in the handoff, not implied by this software result.
