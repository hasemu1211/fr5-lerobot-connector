...
- **AND** 전면 서사는 Demonstration Design·Learning Evidence·Physical Rollout의 가치로 연결하고, 실패 근거에서 조건 진단과 다음 시연으로 돌아가는 발전 방향을 이어 보여 준다. 이 구분은 모듈별 고정 분량이나 전체 기능 나열을 요구하지 않는다
