...
const ENUMS = {
  ...
  workflow_state: new Set(["AUTHORING", "AWAITING_APPROVAL", "RUNNING", "CANCELLING", "BLOCKED", "TERMINAL"]),
};
...
function failClose(code, detail = "") {
  ...
  document.querySelectorAll("button:not(.icon-button), input").forEach((control) => { control.disabled = true; });
